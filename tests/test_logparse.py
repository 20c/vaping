...
config = {
    ...
    "include": ["include"],
    "fields": {
        "str_val": {"type": "str", "parser": r"str_val=(\S+)"},
        "int_val": {"type": "int", "parser": r"int_val=(\S+)"},
        "float_val": {"type": "float", "parser": r"float_val=(\S+)"},
        "eval_val": {"type": "float", "eval": "{int_val}*{float_val}"},
    },
}
...
config_aggr = {
    ...
    "aggregate": {"count": 10},
    "fields": {
        "int_val": {"type": "int", "parser": r"int_val=(\S+)", "aggregate": "sum"},
        "float_val": {
            "type": "float",
        ...
        "no_aggr": {"type": "int", "parser": r"int_val=(\S+)"},
    },
}
...
config_time_parser = {
    ...
    "fields": {"str_val": {"type": "str", "parser": r"str_val=(\S+)"}},
    "time_parser": {
...
@pytest.mark.parametrize(
    "line,iterations,result,raises",
    [
        (
            "include abcde int_val=100 float_val=1.0 abcde",
            10,
